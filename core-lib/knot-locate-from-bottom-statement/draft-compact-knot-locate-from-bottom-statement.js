...
function EchoLocatorAtKnotLocate() {
    ...
    that.traverseInteractionToKnotFromBottomStatement = function (knotConnectedToBottomStatement) {
        ...
        // keep !
        (new Traversar())
            .traverseFromBottomStatementAtTopLeft(knot.throughPointerBelongingsAtTopLeft, /* keep */ knotConnectedToBottomStatement /* keep .throughConnectedKnot */)
            .traverseFromBottomStatementAtBottomLeft(knot.throughPointerBelongingsAtBottomLeft, /* keep */ knotConnectedToBottomStatement /* keep .throughConnectedKnot */)
            .traverseFromBottomStatementAtBottomRight(knot.throughPointerBelongingsAtBottomRight, /* keep */ knotConnectedToBottomStatement /* keep .throughConnectedKnot */)
            .traverseFromBottomStatementAtTopRight(knot.throughPointerBelongingsAtTopRight, /* keep */ knotConnectedToBottomStatement /* keep .throughConnectedKnot */)
            .useKnotRelativeSize(knotRelativeSize)
            .throughPointerBelongingsAtKnotRelativeSize(pointerBelongings)
            .startTraversaring()
    }
...
function KnotFromBottomStatement(pencil) {
    ...
    that.throughCtx = function (ctx) {
        ...
        // keep
        knotFromBottomStatement.ctx.addEventListener('onmouseover', function(event) {
